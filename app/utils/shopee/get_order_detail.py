...
def get_order_detiail(order_sn_list: str, access_token: str, request_order_status_pending=False, response_optional_fields="buyer_username,pay_time,item_list"):
